...
namespace App1
{
    ...
    public class SoftverThree : ContentPage
    {
        ...
        protected override async void OnAppearing()
        {
            ...
            var myDataMainTitle = JsonConvert.DeserializeObject<List<GetSoftver>>(contentMainTitle).Where(GetSoftver => GetSoftver.id == 79);
